          ...
          <tbody>
            ...
            .map((request) => (
              <tr key={request.id} style={{ border: "1px solid black" }}>
                ...
                <td style={{...styles.statusContainer, padding: "5px 50px" }}><span style={{color: request.status === 'Pending' ? "#0d4f90" : "#105631", background: request.status === 'Pending' ? "#d4eaff" : "#E0F5EC", padding: "5px 10px", borderRadius: "20px", fontWeight: "700px"}}>{request.status}</span></td>
